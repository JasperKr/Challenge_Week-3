...
def main():
    ...
    sounds = {
        "collision": pygame.mixer.Sound("assets/taco-bell-bong-sfx.mp3"),
        "horn": pygame.mixer.Sound("assets/dixie-horn.mp3"),
        "collision_car_car": pygame.mixer.Sound("assets/clown-horn-short.mp3"),
    }
